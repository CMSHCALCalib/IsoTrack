...
*/
 ...
 // TBranch        *b_t_mindR2;   //!
  ...
  virtual Int_t      firstLoop(unsigned, bool, bool, unsigned);
  ...
  TH1F* e2pTR_last;
  TH1F* e2pHE_last;
  TH1F* e2pHEM[N_MODULE_GROUPS];
  TH1F* e2pHEP[N_MODULE_GROUPS];
  TH1F* e2pHEMf[N_MODULE_GROUPS];
  TH1F* e2pHEPf[N_MODULE_GROUPS];
  };
